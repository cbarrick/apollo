...
# NAM-ANL
$URL = 'https://nomads.ncdc.noaa.gov/data/namanl/$YYYY$MM/$YYYY$MM$DD/namanl_218_$YYYY$MM$DD_${HH}00_$FHR3';
$inv='.inv';
$grb='.grb';

# # NAM
# $URL = 'https://nomads.ncdc.noaa.gov/data/nam/$YYYY$MM/$YYYY$MM$DD/nam_218_$YYYY$MM$DD_${HH}00_$FHR3';
# $inv='.inv';
# $grb='.grb';
...
if ($#ARGV != 7) {
  ...
  print "       get_grib.pl inv 2006101800 0 0 0 all all .\n\n";
  print " Downloading 500 hPa Height and Temp 0/3/6 hours forecasts to current directory\n\n";
  print "       get_grib.pl data 2006101800 0 6 3 HGT:TMP 500_mb .\n\n";
  print " Downloading PRATE 12/18 hours forecasts to current directory\n\n";
  print "       get_grib.pl data 2006101800 12 18 6 PRATE all .\n\n";
