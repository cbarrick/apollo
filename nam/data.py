...
# The subset of the data grids to extract, as grid indices in (y, x) order.
...
class NAMLoader:
    ...
    def __init__(self,
        ...
        Args:
            ...
            save_netcdf (bool):
                ...
                is ignored when calling `load_grib` directly.
            keep_gribs (bool):
    ...
    def load_grib(self,
        ...
        for path in self.local_gribs:
            vs = preprocess_grib(path, DEFAULT_FEATURES, GEO_SUBSET)
            variables.extend(vs)
